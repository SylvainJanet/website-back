...
public class MenuItemDtoLevel1 extends EntityDto {
	...
	public MenuItemDtoLevel1() {
		super();
		this.depth = -1;
		this.rank = -1;
		this.menuId = -1L;
		this.subItems = new ArrayList<MenuItemDto>();
		this.title = new LocalizedStringDto();
	}

	public MenuItemDtoLevel1(List<MenuItemDto> subItems, int depth, int rank, Long menuId, LocalizedStringDto title,
			PageDto page) {
		super();
		this.depth = -1;
		this.rank = -1;
	...
	public MenuItemDtoLevel1(long id, int version) {
		super(id, version);
		this.depth = -1;
		this.rank = -1;
		this.menuId = -1L;
	...
	public MenuItemDtoLevel1(long id, int version, List<MenuItemDto> subItems, int depth, int rank, Long menuId,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MenuItemDtoLevel1 other = (MenuItemDtoLevel1) obj;
	...
	public String toString() {
		...
		builder.append("MenuItemDtoLevel1 [subItems=").append(subItems).append(", depth=").append(depth)
